...
.DESCRIPTION
Completely removes the LaunchpadIoT solution from a cluster.
...
Deploy a Debug build of the LaunchpadIoT project to a local 5-node cluster.
...
$applicationTypes = "LaunchpadIotAdminApplicationType", "LaunchpadIotEventsProcessorApplicationType", "LaunchpadIotInsightApplicationType"
